...
/**
 * Pelvic floor: the program Cradle started as. Volume and intent shift as
 * pregnancy goes on — awareness first, real strength through the second
 * trimester, then a deliberate hand-off from squeezing to releasing as birth
 * approaches. Postpartum starts from rest and rebuilds.
 *
 * Its session ids are deliberately un-prefixed (`build-a`, not
 * `pelvic-floor-build-a`): they are what every log written before the app had
 * more than one program carries, and renaming them would orphan that history.
 */
    ...
    sessions: [
      ...
      },
      {
        ...
        steps: [
          ...
          {
            type: 'reps',
            exerciseId: 'roll-and-rise',
            reps: 6,
            liftSec: 2,
            holdSec: 2,
            releaseSec: 2,
            restSec: 2,
            note: 'Alternate sides, and take your time getting back down.',
          },
          { type: 'hold', exerciseId: 'posture-reset', durationSec: 45 },
          { type: 'hold', exerciseId: 'full-release', durationSec: 45 },
        ],
    ...
    sessions: [
      ...
      },
      {
        ...
        steps: [
          ...
          {
            type: 'reps',
            exerciseId: 'lift-and-carry',
            reps: 8,
            liftSec: 2,
            holdSec: 2,
            releaseSec: 2,
            restSec: 4,
            note: 'Something light and real — a basket, a full kettle.',
          },
          {
            type: 'reps',
            exerciseId: 'side-lying-clam',
      ...
      },
      {
        ...
        steps: [
          ...
          {
            type: 'reps',
            exerciseId: 'step-up-lift',
            reps: 8,
            liftSec: 2,
            holdSec: 2,
            releaseSec: 2,
            restSec: 5,
            note: 'Alternate the leading leg.',
          },
          {
            type: 'reps',
    ...
    sessions: [
      ...
      },
      {
        ...
        steps: [
          ...
          { type: 'hold', exerciseId: 'posture-reset', durationSec: 60 },
          { type: 'hold', exerciseId: 'child-pose-wide', durationSec: 60 },
          { type: 'hold', exerciseId: 'full-release', durationSec: 60 },
        ],
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            releaseSec: 2,
            restSec: 4,
            note: 'Cough or stand up on each rep, and lift just before it.',
          },
          { type: 'hold', exerciseId: 'child-pose-wide', durationSec: 60 },
          { type: 'hold', exerciseId: 'full-release', durationSec: 45 },
        ],
      ...
      },
      {
        ...
        steps: [
          { type: 'hold', exerciseId: 'connection-breath', durationSec: 60 },
          {
            ...
            releaseSec: 2,
            restSec: 5,
            note: 'Alternate sides. Stop if you feel any dragging or doming.',
          },
          {
            type: 'reps',
            exerciseId: 'side-lying-clam',
      ...
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            releaseSec: 2,
            restSec: 4,
            note: 'Use something with real weight to it.',
          },
          { type: 'hold', exerciseId: 'cat-cow', durationSec: 60 },
          { type: 'hold', exerciseId: 'full-release', durationSec: 45 },
        ],
...
export const pelvicFloorProgram: Program = {
  id: 'pelvic-floor',
  colorKey: 'pelvic-floor',
  title: 'Pelvic floor',
  blurb: 'Lift, hold and release — the muscles that carry and deliver the baby.',
  stages,
};
